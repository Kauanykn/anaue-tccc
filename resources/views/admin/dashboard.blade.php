...
<body>
    ...
    <a href="{{ route('admin.pacotes.index') }}" class="admin-card">
        <div class="admin-card__icone">
            <i class="fa-solid fa-box-open"></i>
        </div>
        <div>
            <span>Pacotes cadastrados</span>
            <strong>{{ $totalPacotes }}</strong>
        </div>
    </a>

    <a href="{{ route('admin.galeria.index') }}" class="admin-card">
        <div class="admin-card__icone">
    ...
    <a href="{{ route('admin.depoimentos.index') }}" class="admin-card">
        <div class="admin-card__icone">
        ...
        <div class="admin-card__conteudo">
            ...
            <div class="admin-depoimentos-media">
                ...
                <span class="admin-depoimentos-estrelas">★★★★★</span>
            </div>
            <small>
                {{ $totalDepoimentos }}
    ...
    <a href="{{ route('admin.orcamentos.index') }}" class="admin-card">
        <div class="admin-card__icone">
            <i class="fa-solid fa-file-invoice-dollar"></i>
        </div>
        <div>
            <span>Orcamentos pendentes</span>
            ...
            <section class="acoes-rapidas">
                ...
                <div class="acoes-grid">
                    ...
                    <a href="{{ route('admin.depoimentos.index') }}" class="btn-administrar-depoimentos">
                        <i class="fa-solid fa-star"></i>
