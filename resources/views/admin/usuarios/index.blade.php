    ...
    <div class="admin-dashboard">
        ...
        <aside class="admin-sidebar">
            ...
            <div class="admin-logo">
                <img src="{{ asset('images/logo.png') }}" alt="Anauê">
            </div>
            ...
            <nav class="admin-menu">
                ...
                <a href="{{ route('admin.pacotes.index') }}" class="admin-link">
                    <i class="fa-solid fa-box-open"></i>
                    Pacotes
                </a>

                <a href="{{ route('admin.galeria.index') }}" class="admin-link">
                    <i class="fa-regular fa-images"></i>
                    Galeria
                </a>

                <a href="{{ route('admin.orcamentos.index') }}" class="admin-link">
                    <i class="fa-solid fa-file-invoice-dollar"></i>
                    Orçamentos
                </a>

                <a href="{{ route('admin.depoimentos.index') }}" class="admin-link">
                    <i class="fa-solid fa-star"></i>
                    Avaliações
                </a>

                <a href="{{ route('admin.usuarios.index') }}" class="admin-link ativo">
